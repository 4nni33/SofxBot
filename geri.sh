...
if wget -q https://github.com/4nni33/SofxBot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;32m\033[01mIniciando SofxBot!!\nStarting SofxBot!!\n\033[0m"
npm start
